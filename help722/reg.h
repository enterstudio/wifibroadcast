...
#define AR_SREV ((AR_SREV_9100(ah)) ? 0x0600 : (AR_SREV_9340(ah) ? 0x400c : 0x4020))
...
#define AR_SREV_5416(_ah)                                                                                                        \
    (((_ah)->hw_version.macVersion == AR_SREV_VERSION_5416_PCI) || ((_ah)->hw_version.macVersion == AR_SREV_VERSION_5416_PCIE))
...
#define AR_SREV_9160_11(_ah) (AR_SREV_9160(_ah) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9160_11))
...
#define AR_SREV_9287_11(_ah)                                                                                                     \
    (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9287) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9287_11))
#define AR_SREV_9287_12(_ah)                                                                                                     \
    (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9287) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9287_12))
...
#define AR_SREV_9271_10(_ah) (AR_SREV_9271(_ah) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9271_10))
...
#define AR_SREV_9300_22(_ah) (AR_SREV_9300(ah) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9300_22))

#define AR_SREV_9330(_ah) (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9330))
#define AR_SREV_9330_11(_ah) (AR_SREV_9330((_ah)) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9330_11))
#define AR_SREV_9330_12(_ah) (AR_SREV_9330((_ah)) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9330_12))
...
#define AR_SREV_9003_PCOEM(_ah) (AR_SREV_9462(_ah) || AR_SREV_9485(_ah) || AR_SREV_9565(_ah))
#else
...
#define AR_SREV_9340(_ah) 0

#define AR_SREV_9340_13(_ah) (AR_SREV_9340((_ah)) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9340_13))

//#define AR_SREV_9340_13_OR_LATER(_ah)
//    (AR_SREV_9340((_ah)) &&
//     ((_ah)->hw_version.macRev >= AR_SREV_REVISION_9340_13))

#define AR_SREV_9285E_20(_ah) //    (AR_SREV_9285_12_OR_LATER(_ah) &&
//     ((REG_READ(_ah, AR_AN_SYNTH9) & 0x7) == 0x1))

#define AR_SREV_9462_20(_ah) (AR_SREV_9462(_ah) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9462_20))
#define AR_SREV_9462_21(_ah) (AR_SREV_9462(_ah) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9462_21))
...
#define AR_SREV_9565_10(_ah) (AR_SREV_9565(_ah) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9565_10))
#define AR_SREV_9565_101(_ah) (AR_SREV_9565(_ah) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9565_101))
#define AR_SREV_9565_11(_ah) (AR_SREV_9565(_ah) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9565_11))
...
#define AR_SREV_9580(_ah)                                                                                                        \
    (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9580) && ((_ah)->hw_version.macRev >= AR_SREV_REVISION_9580_10))
#define AR_SREV_9580_10(_ah)                                                                                                     \
    (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9580) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9580_10))

#define AR_SREV_9531(_ah) (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9531))
#define AR_SREV_9531_10(_ah)                                                                                                     \
    (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9531) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9531_10))
#define AR_SREV_9531_11(_ah)                                                                                                     \
    (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9531) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9531_11))
#define AR_SREV_9531_20(_ah)                                                                                                     \
    (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9531) && ((_ah)->hw_version.macRev == AR_SREV_REVISION_9531_20))

#define AR_SREV_9561(_ah) (((_ah)->hw_version.macVersion == AR_SREV_VERSION_9561))
...
#define AR_DEVID_7010(_ah) (((_ah)->hw_version.usbdev == AR9280_USB) || ((_ah)->hw_version.usbdev == AR9287_USB))
...
enum {
    ...
    AR_INTR_SYNC_DEFAULT = (AR_INTR_SYNC_HOST1_FATAL | AR_INTR_SYNC_HOST1_PERR | AR_INTR_SYNC_RADM_CPL_EP |
                            AR_INTR_SYNC_RADM_CPL_DLLP_ABORT | AR_INTR_SYNC_RADM_CPL_TLP_ABORT | AR_INTR_SYNC_RADM_CPL_ECRC_ERR |
                            AR_INTR_SYNC_RADM_CPL_TIMEOUT | AR_INTR_SYNC_LOCAL_TIMEOUT | AR_INTR_SYNC_MAC_SLEEP_ACCESS),
...
#define AR_INTR_ASYNC_USED (AR_INTR_MAC_IRQ | AR_INTR_ASYNC_CAUSE_MCI)
...
#define AR_PMCTRL_HOST_PME_EN                                                                                                    \
    0x00400000                                   /* Send OOB WAKE_L on WoW                                                       \
                               event */
